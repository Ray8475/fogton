...
- [ ] Модель/таблица withdrawals (по vision при наличии)
- [ ] API: POST /me/withdraw — amount, destination address; проверка баланса, создание заявки
- [ ] API: GET /me/withdrawals или в GET /me — список/статусы выводов
- [ ] Отправка on-chain — заглушка или реальный вызов (по возможностям); фиксация tx_hash при успехе
- [ ] Mini App: форма вывода и отображение статусов
