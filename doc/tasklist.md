...
| 6. Вывод (заявка и статус) | 🔄 В работе | — | |
...
- [ ] API: проверка ADMIN_TOKEN в заголовке Authorization для админ-роутов
- [ ] PATCH (или POST) админ: включить/выключить gift, expiry, market (is_active)
- [ ] POST админ: корректировка баланса пользователя (user_id, currency, delta, reason); запись в ledger_entries, обновление balances
